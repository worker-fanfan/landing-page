...
export const FAQS_ZH = [
  {
    title: "为什么选择荟安家？",
    content:
      "荟安家房屋管理系统功能全面，操作便捷，可以帮助物业公司提高管理效率、降低运营成本、提升服务质量，为业主和住户提供更舒适便利的生活体验。该系统是物业公司数字化转型升级的理想选择。总体而言，荟安家房屋管理系统是一款功能强大、易于使用、性价比高的房屋管理系统，值得物业公司选择。",
  },
  {
    title: "如果我在使用过程中遇到问题该怎么办？",
    content:
      "如果你在使用过程中遇到任何问题，请通过Email: gufanfan.worker@gmail.com 与我们联系。",
  },
];
